...
const Modal = ({ header, footer, message, show, onCancel }) => {
  return ReactDOM.createPortal(
    <CSSTransition
      ...
      unmountOnExit
    >
      <div className="fixed left-[25%] top-[40%] bg-whiterounded-lg shadow-2xl w-[50%] z-50">
        ...
        <div className="bg-white p-1 flex flex-col justify-center items-center rounded-b-lg">
          <p className="text-center text-[11px] md:text-sm font-paris font-bold p-4">
            {message}
          </p>
          <div className="flex w-full justify-evenly p-1">
            {footer === "CancelConfirm" && (
              <>
                ...
                <button className="text-sm text-white bg-red-800 hover:bg-red-600 shadow-md p-1 rounded-lg w-20">
                  CONFIRM
                </button>
              </>
            )}
